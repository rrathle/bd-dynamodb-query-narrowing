...
public class LogDAO {
    ...
    public List<Log> getLogsBetweenTimes(String logLevel, String startTime, String endTime) {
        ...
        valueMap.put(":log_level", new AttributeValue().withS(logLevel));
        ...
        DynamoDBQueryExpression<Log> queryExpression = new DynamoDBQueryExpression<Log>()
                .withKeyConditionExpression("log_level = :log_level and time_stamp between :startTime and :endTime")
    ...
    public List<Log> getLogsBeforeTime(String logLevel, String endTime) {
        ...
        DynamoDBQueryExpression<Log> queryExpression = new DynamoDBQueryExpression<Log>()
                .withKeyConditionExpression("log_level = :log_level and time_stamp < :endTime")
                .withExpressionAttributeValues(valueMap);
    ...
    public List getLogsAfterTime(String logLevel, String startTime) {
        Map<String, AttributeValue> valueMap = new HashMap<>();
        valueMap.put(":log_level", new AttributeValue().withS(logLevel));
        valueMap.put(":endTime", new AttributeValue().withS(startTime));

        DynamoDBQueryExpression<Log> queryExpression = new DynamoDBQueryExpression<Log>()
                .withKeyConditionExpression("log_level = :log_level and time_stamp > :startTime")
                .withExpressionAttributeValues(valueMap);
